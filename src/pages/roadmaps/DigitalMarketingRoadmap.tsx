...
const DigitalMarketingRoadmap: React.FC = () => {
  ...
  const handleBookmark = () => {
    ...
    toast({
      ...
      description: `Digital Marketing Roadmap ${bookmarked ? "removed from" : "added to"} your bookmarks.`,
    });
  };
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          <div>
            <div className="flex items-center mb-4">
              ...
              <h1 className="text-3xl md:text-4xl font-bold">Digital Marketing Roadmap</h1>
            </div>
            <p className="text-lg text-muted-foreground mb-6 max-w-3xl">
              Your guide to SEO, content marketing, social media, and other essential digital marketing skills.
            </p>
