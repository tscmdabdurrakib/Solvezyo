...
const AiMlRoadmap: React.FC = () => {
  ...
  const handleBookmark = () => {
    ...
    toast({
      ...
      description: `Artificial Intelligence & Machine Learning Roadmap ${bookmarked ? "removed from" : "added to"} your bookmarks.`,
    });
  };
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          <div>
            <div className="flex items-center mb-4">
              ...
              <h1 className="text-3xl md:text-4xl font-bold">Artificial Intelligence & Machine Learning Roadmap</h1>
            </div>
            <p className="text-lg text-muted-foreground mb-6 max-w-3xl">
              Explore the world of AI and ML, from basic concepts to advanced neural networks.
            </p>
