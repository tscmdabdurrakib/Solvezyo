...
const BlockchainCryptoRoadmap: React.FC = () => {
  ...
  const handleBookmark = () => {
    ...
    toast({
      ...
      description: `Blockchain & Crypto Roadmap ${bookmarked ? "removed from" : "added to"} your bookmarks.`,
    });
  };
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          <div>
            <div className="flex items-center mb-4">
              <Bitcoin className="h-10 w-10 text-primary mr-3" />
              <h1 className="text-3xl md:text-4xl font-bold">Blockchain & Crypto Roadmap</h1>
            </div>
            <p className="text-lg text-muted-foreground mb-6 max-w-3xl">
              Dive into the world of decentralized technology, cryptocurrencies, and smart contracts.
            </p>
...
export default BlockchainCryptoRoadmap;