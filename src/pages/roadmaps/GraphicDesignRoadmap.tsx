...
const GraphicDesignRoadmap: React.FC = () => {
  ...
  const handleBookmark = () => {
    ...
    toast({
      ...
      description: `Graphic Design Roadmap ${bookmarked ? "removed from" : "added to"} your bookmarks.`,
    });
  };
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          <div>
            <div className="flex items-center mb-4">
              ...
              <h1 className="text-3xl md:text-4xl font-bold">Graphic Design Roadmap</h1>
            </div>
            <p className="text-lg text-muted-foreground mb-6 max-w-3xl">
              A step-by-step guide to visual communication, branding, and design principles.
            </p>
