...
const UiUxDesignRoadmap: React.FC = () => {
  ...
  const handleBookmark = () => {
    ...
    toast({
      ...
      description: `UI/UX Design Roadmap ${bookmarked ? "removed from" : "added to"} your bookmarks.`,
    });
  };
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          <div>
            <div className="flex items-center mb-4">
              <PenTool className="h-10 w-10 text-primary mr-3" />
              <h1 className="text-3xl md:text-4xl font-bold">UI/UX Design Roadmap</h1>
            </div>
            <p className="text-lg text-muted-foreground mb-6 max-w-3xl">
              Learn to create intuitive and user-friendly digital experiences with this comprehensive guide.
            </p>
