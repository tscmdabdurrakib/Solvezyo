...
export default function WordToPDFConverter() {
  ...
  const handleDownload = useCallback(() => {
    ...
    const blob = new Blob(['Converted PDF Document Content'], { type: 'application/pdf' });
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg max-w-2xl mx-auto">
            Convert Word files to high-quality PDF documents with preserved formatting
          </p>
        </motion.div>
              ...
              {!wordFile ? (
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-2 text-lg">
                    Drag and drop a Word file here, or click to select
                  </p>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-semibold py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl"
                    >
            ...
            <CardContent>
              <ol className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                <li className="flex gap-2">
                  ...
                  <span>Upload your Word file (.doc or .docx) by dragging and dropping or clicking the upload area</span>
                </li>
                <li className="flex gap-2">
                ...
                <li className="flex gap-2">
                  ...
                  <span>Share or print the PDF file as needed</span>
                </li>
              </ol>
            </CardContent>
          </Card>
