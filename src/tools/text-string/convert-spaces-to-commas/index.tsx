...
function ConvertSpacesToCommas() {
  ...
  const copyToClipboard = async () => {
    ...
    try {
      ...
      toast({
        title: "Copied!",
        description: "Text with commas copied to clipboard",
      });
    } catch (err) {
      toast({
      ...
      <Card className="border-2 shadow-lg">
        <CardHeader className="text-center space-y-2 pb-4 bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-950/20 dark:to-violet-950/20">
          <div className="flex items-center justify-center gap-2">
            ...
            <CardTitle className="text-2xl">Convert Spaces to Commas</CardTitle>
          </div>
          <CardDescription>Replace all spaces with commas instantly</CardDescription>
        </CardHeader>
        <CardContent className="pt-6 space-y-4">
          ...
          <div>
            <Label htmlFor="output">Output (With Commas):</Label>
            <Textarea
              id="output"
              ...
              placeholder="Text with commas will appear here..."
            />
          </div>
...
export default ConvertSpacesToCommas;
